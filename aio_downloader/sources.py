...
class RedisSource(Source):
    ...
    def __init__(self, redis_host, redis_port, redis_db, redis_key, **kwargs):
        try:
        ...
        self.redis_conn = Redis(redis_host, redis_port, redis_db)
    ...
    @staticmethod
    def enrich_parser(sub_parser):
        sub_parser.add_argument("-rh", "--redis-host", default="127.0.0.1", help="Default 127.0.0.1")
        sub_parser.add_argument("-rp", "--redis-port", default=6379, help="Default 6379")
        sub_parser.add_argument("-rd", "--redis-db", default=0, help="Default 0")
        sub_parser.add_argument("-rk", "--redis-key", default="download_meta", help="Default `download_meta`")
...
class CmdlineSource(Source):
    ...
    def enrich_parser(sub_parser):
        sub_parser.add_argument(
            "--filename", help="Filename to save file. ")
